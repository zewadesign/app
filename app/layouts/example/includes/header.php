...
<head>
    ...
    <link rel="stylesheet" href="<?= baseURL('resources/bootstrap/dist/css/bootstrap.min.css') ?>">
    <link href="<?= baseURL('resources/bootstrap/dist/css/bootstrap-theme.min.css') ?>" rel="stylesheet">
